namespace UnityEngine.Rendering.PostProcessing
{
    ...
    static class ShaderIDs
    {
        ...
        internal static readonly int RadialBlurTex                   = Shader.PropertyToID("_RadialBlurTex");
        internal static readonly int RadialBlurParams                = Shader.PropertyToID("_RadialBlur_Params");
        internal static readonly int RadialBlurOffset                = Shader.PropertyToID("_RadialBlurOffset");
        internal static readonly int RadialBlurCenter                = Shader.PropertyToID("_RadialBlurCenter");
        internal static readonly int RadialBlurSpectralLut           = Shader.PropertyToID("_RadialBlurSpectralLut");
        internal static readonly int RadialBlurFilter                = Shader.PropertyToID("_RadialBlurFilter");

        internal static readonly int MyRadialBlurParam               = Shader.PropertyToID("_MyRadialBlurParam");

        internal static readonly int MyBloomTex                      = Shader.PropertyToID("_MyBloomTex");
        internal static readonly int FilterThreshold                 = Shader.PropertyToID("_FilterThreshold");
        internal static readonly int FilterScaler                    = Shader.PropertyToID("_FilterScaler");
        ...
        internal static readonly int MyBloomIntensity                = Shader.PropertyToID("_MyBloom_Intensity");
    }
}
