Shader "DynamicFog/Image Effect/Desktop Plus" {
	...
	// Global
	fixed4 _DALGlobalEnvironmentColor;
	...
	inline fixed4 computeSkyColor(fixed4 color, float3 worldPos) {
		...
		// Global Dark
		_FogColor.rgb = _FogColor.rgb * _DALGlobalEnvironmentColor.rgb;
		_FogColor.rgb = _FogColor.rgb * _DALGlobalEnvironmentColor.a;
		_FogColor2.rgb = _FogColor2.rgb * _DALGlobalEnvironmentColor.rgb;
		_FogColor2.rgb = _FogColor2.rgb * _DALGlobalEnvironmentColor.a;
