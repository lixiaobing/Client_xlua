...
return
{
	...
	stateMap = {
		...
		["Win"] = {
			length = Fixed64(3005918) --[[2.866667]],
			loop = false,
			transitions = {
			}
		},
		...
		["Skill4"] = {
			length = Fixed64(6011836) --[[5.733334]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
		...
		["Skill3"] = {
			length = Fixed64(2970965) --[[2.833333]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
		...
		["HitFly"] = {
			length = Fixed64(1852484) --[[1.766667]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
