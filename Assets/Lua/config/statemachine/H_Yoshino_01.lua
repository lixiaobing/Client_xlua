...
return
{
	...
	stateMap = {
		...
		["IdleRelax"] = {
			length = Fixed64(4369067) --[[4.166667]],
			loop = false,
			transitions = {
				[1] = {
					name = "Idle",
		...
		["Run"] = {
			length = Fixed64(244668) --[[0.2333333]],
			loop = false,
			transitions = {
				[1] = {
					name = "RunFast",
		...
		["Attack2"] = {
			length = Fixed64(1013623) --[[0.9666667]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
		...
		["Skill4"] = {
			length = Fixed64(8039083) --[[7.666667]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
		...
		["Skill3"] = {
			length = Fixed64(2341820) --[[2.233333]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
		...
		["Rush"] = {
			length = Fixed64(594193) --[[0.5666667]],
			loop = false,
			transitions = {
				[1] = {
					name = "IdleBattle",
